<template>
  <v-app-bar app dark color="primary">
    ...
    <v-btn color="info" v-if="isLoggedIn && (isAdministrator)" v-bind:to="{name: 'update-vehicle-page'}">
			Update Vehicle
		</v-btn>
    ...
    <v-btn color="info" v-if="isLoggedIn && isPassenger" v-bind:to="{name: 'ride-signup-page'}">
      Ride Signup
    </v-btn>

    <v-btn color="info" v-if="isLoggedIn && isDriver" v-bind:to="{name: 'driver-report-page'}">
      Driver Reports
    </v-btn>
